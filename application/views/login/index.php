                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-logo">
                            <a href="#">
                                <img src="<?= base_url() ?>/assets/images/logo.png" width="120px">
                            </a>
                        </div>
                        <div class="text-center">
                            <p><b>Selamat Datang di Aplikasi Pengelolaan Unit Rusunawa Universitas Muhammadiyah Parepare</b></p>
                        </div>
                        <br>
